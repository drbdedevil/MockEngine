    ...
    glfwSetWindowCloseCallback(m_window, [](GLFWwindow* window) 
        {
            ...
            M_LOG(LogGLFWWindow, Display, "Window with id={} closed!", thisWindow->m_id.value);
    ...
    glfwSetFramebufferSizeCallback(m_window, [](GLFWwindow* window, int width, int height) 
        {
            ...
            M_LOG(LogGLFWWindow, Display, "Resize window with id={}: x={}; y{};", thisWindow->m_id.value, width, height);
    ...
    glfwSetKeyCallback(m_window, [](GLFWwindow* window, int key, int scancode, int action, int mods)
        {
            ...
            M_LOG(LogGLFWWindow, Display, "Key={}; Scancode={}; Action={}; Mods={};", key, scancode, action, mods);
    ...
    glfwSetCursorPosCallback(m_window, [](GLFWwindow* window, double xpos, double ypos)
        {
            ...
            // M_LOG(LogGLFWWindow, Display, "Mouse: x={}; y={};", xpos, ypos);
    ...
    glfwSetMouseButtonCallback(m_window, [](GLFWwindow* window, int button, int action, int mods)
        {
            ...
            M_LOG(LogGLFWWindow, Display, "Button={}; Action={}; Mods={};", button, action, mods);
    ...
    glfwSetScrollCallback(m_window, [](GLFWwindow* window, double xoffset, double yoffset)
        {
            ...
            M_LOG(LogGLFWWindow, Display, "Mouse scroll: x={}; y={};", xoffset, yoffset);
